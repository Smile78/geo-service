...
//            System.out.printf("Отправлено сообщение: %s", localizationService.locale(location.getCountry())); //просто вывод

            return localizationService.locale(location.getCountry());   // авот это возврат
        }

        return localizationService.locale(Country.USA); // авот это дефолт
    }
}
